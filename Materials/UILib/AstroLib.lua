local Lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/0306191026/scripts/main/Materials/UILib/UISource/AstroLib.lua"))()
...
-------------
local Toggle1 = Section1:CreateToggle("Toggle 1", true, function(State)
	print(State)
end)
...
Section1:CreateButton("Update dropdown", function()
	Dropdown1:Update({1,2,3,4,5,6})
end)
-------------
