...
local library = {
	...
	colored = {},
	configuration = {
        hideKeybind = Enum.KeyCode.Delete,
        smoothDragging = true,
        easingStyle = Enum.EasingStyle.Quart,
        easingDirection = Enum.EasingDirection.Out
    },
    colors = {
        main = Color3.fromRGB(1, 255, 255),
        background = Color3.fromRGB(18, 18, 18),
        outerBorder = Color3.fromRGB(15, 15, 15),
        innerBorder = Color3.fromRGB(88, 1, 221),
		...
		function tabFunctions:CreateSection(options)
			...
			function sectionFunctions:AddToggle(options)
				...
				if alreadyEnabled then
					task.spawn(callback, alreadyEnabled)
				end
			...
			function sectionFunctions:AddDropdown(options)
				...
				local function AddOptions(optionsTable)
					...
					if blankstring and optionsTable[1] ~= blankstring then
						table.insert(optionsTable, 1, blankstring)
					end
					optionCount = 0
					realDropdownHolderList.Parent = nil
