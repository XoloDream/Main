...
function library:Window(TitleWhite)
    if game.CoreGui:FindFirstChild(TitleWhite) then
        game.CoreGui:FindFirstChild(TitleWhite):Destroy()
    end
    ...
    BloxburgHubTitle.Text = TitleWhite
    ...
    function window.Toggle()
        if ScreenUI.Enabled == false then
    ...
    function window:Notification(Type, content, callback)
        if Type == "Message" then
            ...
            NotificationMain.Parent = ScreenUI
    ...
    function window:Tab(name)
        ...
        function tab:Section(name)
            ...
            function section:Picker(name, options, default, callback)
                default = default 
                ...
                KeybindButton.MouseButton1Click:Connect(function()
                    ...
                    connection = game:GetService("UserInputService").InputBegan:Connect(function(i)
                        if i.UserInputType.Name == "Keyboard" and i.KeyCode ~= Enum.KeyCode.Backspace then
                            KeybindValue.Text = i.KeyCode.Name
                            bind = i.KeyCode
                            if connection then
            ...
            function section:SearchBox(name, options, default, callback)
                default = default 
